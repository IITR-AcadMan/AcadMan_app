...
public class DefaultSchedule extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
View v;
  ...
  List<String> slotmap =  new ArrayList<String>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SharedPreferences dssp = getActivity().getSharedPreferences("Personal_Data", getActivity().MODE_PRIVATE);
        tidsp  = dssp.getString("tid", "null");
        tokensp = dssp.getString("token","null");
