...
public class UpcomingSchedule extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
View v;
  ...
  List<String> slotmap =  new ArrayList<String>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String courseJSON  = courselistsp.getString("us", "null");
                         ...
                         if (isOnline()) {
                             ...
                             cganhesshe.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener()
                             {
                                 ...
                                 public void onClick(View v){
                                     ...
                                     PostRequest sendcha= new PostRequest(new String[]{"reqid=","&tid=","&token=","&slot=","&venue=","&type=","&schedule=","&course="},new String[]{"6",tidsp,tokensp,slot,"",radiotag,"us",(String)coulist.getSelectedItem()});
                                     sendcha.execute();
